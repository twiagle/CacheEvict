...
public class AnalyzeTab extends JPanel {
    ...
    private void initComponents() {
        ...
        jTableAlgoritms.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jTableStreams.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jButtonDelAlgoritm.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButtonDelStream.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jButtonImage.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void jButtonResultsActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonResultsActionPerformed
    ...
    private void jButtonDelAlgoritmActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonDelAlgoritmActionPerformed
    ...
    private void jButtonDelStreamActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonDelStreamActionPerformed
    ...
    private void jButtonImageActionPerformed(ActionEvent evt) {//GEN-FIRST:event_jButtonImageActionPerformed
